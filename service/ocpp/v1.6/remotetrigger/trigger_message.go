...
func isValidMessageTrigger(fl validator.FieldLevel) bool {
	...
	switch trigger {
	case core.BootNotification, firmware.DiagnosticsStatusNotification, firmware.FirmwareStatusNotification, core.Heartbeat, core.MeterValues, core.StatusNotification:
		return true
	default:
		return false
	}
